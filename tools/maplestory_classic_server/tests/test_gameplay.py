...
class GameplayPacketShapeTest(unittest.TestCase):
    ...
    def test_remote_player_lifecycle_round_trip_and_redacts_identity(
        ...
        self.assertEqual(entered.body.safe_dict()["opaque_tail_bytes"], 73)
        ...
        self.assertEqual(
            RemotePlayerEnterField.parse(populated_tail.to_bytes()),
            populated_tail,
        )
        self.assertEqual(
            ...
            replace(
                ...
                body=replace(
                    ...
                    tail_prefix=replace(
                        ...
                        continuation_flag_bytes=(1, 0),
                    ),
                ),
            ).to_bytes()
        with self.assertRaisesRegex(PacketShapeError, "end in zero"):
            replace(
                entered,
                body=replace(
                    entered.body,
