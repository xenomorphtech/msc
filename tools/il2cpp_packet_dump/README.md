...
manifest currently declares 97 semantic/manual shapes and 96 explicitly
...
opcode `279` add the sixteenth and seventeenth overlaps. This leaves 176 active
shapes and 79 active opaque pins.
