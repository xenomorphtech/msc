...
manifest currently declares 92 semantic/manual shapes and 96 explicitly
...
overlaps. The added widths found only in `1-10FS` leave 175 active shapes and
83 active opaque pins.
